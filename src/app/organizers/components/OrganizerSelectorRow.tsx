...
const OrganizerSelectorRow = ({
  ...
  <button
    type="button"
    onClick={onClick}
    className="flex w-full items-center justify-between rounded-lg bg-white px-4 py-3 text-left shadow-[0_2px_3px_var(--color-gray-200)] transition-all duration-150 hover:bg-gray-200"
  >
