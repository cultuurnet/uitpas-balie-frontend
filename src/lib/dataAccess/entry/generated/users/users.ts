...
export const getUserGetQueryOptions = <TData = Awaited<ReturnType<typeof userGet>>, TError = AxiosError<UnauthorizedResponse | NotFoundResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userGet>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
export const useUserGet = <TData = Awaited<ReturnType<typeof userGet>>, TError = AxiosError<UnauthorizedResponse | NotFoundResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userGet>>, TError, TData>, axios?: AxiosRequestConfig}
