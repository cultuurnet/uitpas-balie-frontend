 ...
 */
export type PlacePriceInfoItemCategory = typeof PlacePriceInfoItemCategory[keyof typeof PlacePriceInfoItemCategory];


export const PlacePriceInfoItemCategory = {
  base: 'base',
  tariff: 'tariff',
  uitpas: 'uitpas',
} as const;
