...
import type { PlacePriceInfoItemCategory } from './placePriceInfoItemCategory';
import type { PlacePriceInfoItemPriceCurrency } from './placePriceInfoItemPriceCurrency';

export type PlacePriceInfoItem = unknown & {
...
`base` for the base price, and `tariff` for custom/extra tariffs.  Tariffs with category `uitpas` are automatically added by UiTdatabank and read-only. They will be updated whenever other tariffs change. */
  category: PlacePriceInfoItemCategory;
  /**
  ...
  priceCurrency?: PlacePriceInfoItemPriceCurrency;
