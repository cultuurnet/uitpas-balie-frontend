...
export const getGetUitidEmailInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getUitidEmail>>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(email: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getUitidEmail>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Retrieve UiTiD email address status
 */
export const useGetUitidEmailInfinite = <TData = InfiniteData<Awaited<ReturnType<typeof getUitidEmail>>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 email: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getUitidEmail>>, TError, TData>>, axios?: AxiosRequestConfig}
...
export const getGetUitidEmailQueryOptions = <TData = Awaited<ReturnType<typeof getUitidEmail>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(email: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUitidEmail>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
export const useGetUitidEmail = <TData = Awaited<ReturnType<typeof getUitidEmail>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 email: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getUitidEmail>>, TError, TData>>, axios?: AxiosRequestConfig}
