...
export const postOrders = (
  ...
  return axios.post(`NEXT_PUBLIC_API_PATH/orders`, order, options);
};
...
export type PostOrdersMutationError = AxiosError<
...
export const getOrdersOrderid = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/orders/${orderId}`, options);
};
...
export const getGetOrdersOrderidQueryOptions = <
  ...
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error | void>,
>(
  orderId: string,
  options?: {
    query?: Partial<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetOrdersOrderidQueryKey(orderId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getOrdersOrderid>>
  > = ({ signal }) => getOrdersOrderid(orderId, { signal, ...axiosOptions });
...
export type GetOrdersOrderidQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOrdersOrderid>>
>;
export type GetOrdersOrderidQueryError = AxiosError<
  UnauthorizedResponse | ForbiddenResponse | Error | void
>;
