...
export const Permission = {
  ...
  PASSHOLDERS_WRITE_SOCIALTARIFF_FULL_CARDSYSTEM: 'PASSHOLDERS_WRITE_SOCIALTARIFF_FULL_CARDSYSTEM',
  PASSHOLDERS_WRITE_FOREIGN_COUNTRY: 'PASSHOLDERS_WRITE_FOREIGN_COUNTRY',
  PASSHOLDERS_WRITE_SOCIALTARIFF: 'PASSHOLDERS_WRITE_SOCIALTARIFF',
  ...
  SOCIALTARIFF_EXPORT: 'SOCIALTARIFF_EXPORT',
} as const;
