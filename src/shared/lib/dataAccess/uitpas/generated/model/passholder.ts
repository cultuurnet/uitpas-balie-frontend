...
export interface Passholder {
  ...
  uitpasNumber?: string;
  /** This field is always available in responses. */
  readonly cardSystemMemberships?: readonly CardSystemMembership[];
  ...
  /** Only used in passholder registration using a `registrationUitpasNumber` with social tariff. If no `registrationSocialTariffEndDate` is specified and `registrationUitpasNumber` has social tariff, a default date of April 30 of next year is used. */
  registrationSocialTariffEndDate?: string;
}
