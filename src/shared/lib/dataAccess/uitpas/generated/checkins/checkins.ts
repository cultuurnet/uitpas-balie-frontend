...
export const getCheckinStatus = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/checkin-status`, {
    ...options,
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCheckinStatus>>
  > = ({ signal }) => getCheckinStatus(params, { signal, ...axiosOptions });
...
export type GetCheckinStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCheckinStatus>>
>;
export type GetCheckinStatusQueryError = AxiosError<
 ...
 * @summary Get checkin status
 */
export const useGetCheckinStatus = <
  TData = Awaited<ReturnType<typeof getCheckinStatus>>,
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>,
>(
  params: GetCheckinStatusParams,
