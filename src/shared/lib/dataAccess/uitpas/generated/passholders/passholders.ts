...
export const getPassholders = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/passholders`, {
    ...options,
...
export const getGetPassholdersQueryOptions = <
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getPassholders>>, TError, TData>
    >;
...
export const postPassholders = (
  passholder: NonReadonly<Passholder>,
  options?: AxiosRequestConfig
): Promise<AxiosResponse<Passholder>> => {
  return axios.post(`NEXT_PUBLIC_API_PATH/passholders`, passholder, options);
};

export const getPostPassholdersMutationOptions = <
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
  TContext = unknown,
>(options?: {
...
export const deletePassholdersPassholderId = (
  ...
  return axios.delete(
    `NEXT_PUBLIC_API_PATH/passholders/${passholderId}`,
    options
  );
};

export const getDeletePassholdersPassholderIdMutationOptions = <
...
> => {
  const mutationOptions =
    getDeletePassholdersPassholderIdMutationOptions(options);
...
export const getGetPassholdersPassholderIdPictureQueryKey = (
  passholderId: string
) => {
...
export const getGetPassholdersPassholderIdPictureQueryOptions = <
  TData = Awaited<ReturnType<typeof getPassholdersPassholderIdPicture>>,
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>,
>(
  passholderId: string,
  options?: {
  ...
  const queryKey =
    ...
    getGetPassholdersPassholderIdPictureQueryKey(passholderId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPassholdersPassholderIdPicture>>
  > = ({ signal }) =>
    getPassholdersPassholderIdPicture(passholderId, {
      signal,
      ...axiosOptions,
    });
...
export type GetPassholdersPassholderIdPictureQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPassholdersPassholderIdPicture>>
>;
export type GetPassholdersPassholderIdPictureQueryError = AxiosError<
  UnauthorizedResponse | ForbiddenResponse | Error
>;
 ...
 * @summary Get picture of passholder
 */
export const useGetPassholdersPassholderIdPicture = <
  TData = Awaited<ReturnType<typeof getPassholdersPassholderIdPicture>>,
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>,
>(
  passholderId: string,
  ...
  const queryOptions = getGetPassholdersPassholderIdPictureQueryOptions(
    passholderId,
    options
  );
 ...
 */
export const getPassholdersPassholderIdAssociationMemberships = (
  passholderId: string,
  params: GetPassholdersPassholderIdAssociationMembershipsParams,
  options?: AxiosRequestConfig
): Promise<AxiosResponse<AssociationMembership[]>> => {
  return axios.get(
    `NEXT_PUBLIC_API_PATH/passholders/${passholderId}/association-memberships`,
    {
      ...options,
      params: { ...params, ...options?.params },
    }
...
export const getGetPassholdersPassholderIdAssociationMembershipsQueryKey = (
  passholderId: string,
  params: GetPassholdersPassholderIdAssociationMembershipsParams
) => {
  return [
...
export const getGetPassholdersPassholderIdAssociationMembershipsQueryOptions = <
  TData = Awaited<
    ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>
  >,
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>,
>(
  passholderId: string,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetPassholdersPassholderIdAssociationMembershipsQueryKey(
      passholderId,
      params
    );
  ...
  > = ({ signal }) =>
    getPassholdersPassholderIdAssociationMemberships(passholderId, params, {
      signal,
      ...axiosOptions,
    });
...
export type GetPassholdersPassholderIdAssociationMembershipsQueryResult =
  NonNullable<
    Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>
  >;
export type GetPassholdersPassholderIdAssociationMembershipsQueryError =
  AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>;

/**
 * @summary Get association memberships of passholder
 */
export const useGetPassholdersPassholderIdAssociationMemberships = <
  TData = Awaited<
    ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>
  >,
  TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>,
>(
  ...
  const queryOptions =
    getGetPassholdersPassholderIdAssociationMembershipsQueryOptions(
      passholderId,
      params,
      options
    );
...
export const getGetPassholdersMembershipPricesCardSystemIdQueryKey = (
  cardSystemId: number,
  params: GetPassholdersMembershipPricesCardSystemIdParams
) => {
  return [
...
export const getGetPassholdersMembershipPricesCardSystemIdQueryOptions = <
  TData = Awaited<
    ReturnType<typeof getPassholdersMembershipPricesCardSystemId>
  >,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
>(
  cardSystemId: number,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetPassholdersMembershipPricesCardSystemIdQueryKey(cardSystemId, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPassholdersMembershipPricesCardSystemId>>
  > = ({ signal }) =>
    getPassholdersMembershipPricesCardSystemId(cardSystemId, params, {
      signal,
      ...axiosOptions,
    });
...
export type GetPassholdersMembershipPricesCardSystemIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPassholdersMembershipPricesCardSystemId>>
>;
export type GetPassholdersMembershipPricesCardSystemIdQueryError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse
>;
 ...
 * @summary Retrieve new membership price
 */
export const useGetPassholdersMembershipPricesCardSystemId = <
  TData = Awaited<
    ReturnType<typeof getPassholdersMembershipPricesCardSystemId>
  >,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
>(
  ...
  const queryOptions =
    getGetPassholdersMembershipPricesCardSystemIdQueryOptions(
      cardSystemId,
      params,
      options
    );
...
export const getGetPassholdersPassholderIdMembershipPricesCardSystemIdQueryKey =
  (
    passholderId: string,
    cardSystemId: number,
    params: GetPassholdersPassholderIdMembershipPricesCardSystemIdParams
...
export const getGetPassholdersPassholderIdMembershipPricesCardSystemIdQueryOptions =
  <
    TData = Awaited<
      ReturnType<typeof getPassholdersPassholderIdMembershipPricesCardSystemId>
    >,
    TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
  >(
    passholderId: string,
    ...
    options?: {
      query?: Partial<
        UseQueryOptions<
          Awaited<
            ReturnType<
              typeof getPassholdersPassholderIdMembershipPricesCardSystemId
            >
          >,
          TError,
          TData
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getGetPassholdersPassholderIdMembershipPricesCardSystemIdQueryKey(
        passholderId,
        cardSystemId,
        params
      );
    ...
    return {
      queryKey,
      queryFn,
      enabled: !!(passholderId && cardSystemId),
      ...queryOptions,
    } as UseQueryOptions<
      Awaited<
        ReturnType<
...
export type GetPassholdersPassholderIdMembershipPricesCardSystemIdQueryResult =
  NonNullable<
    Awaited<
      ReturnType<typeof getPassholdersPassholderIdMembershipPricesCardSystemId>
    >
  >;
export type GetPassholdersPassholderIdMembershipPricesCardSystemIdQueryError =
  AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>;

/**
 * @summary Retrieve upgrade membership price
 */
export const useGetPassholdersPassholderIdMembershipPricesCardSystemId = <
  TData = Awaited<
    ReturnType<typeof getPassholdersPassholderIdMembershipPricesCardSystemId>
  >,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
>(
  ...
  const queryOptions =
    getGetPassholdersPassholderIdMembershipPricesCardSystemIdQueryOptions(
      passholderId,
      cardSystemId,
      params,
      options
...
export const postPassholdersPassholderIdCheckin = (
  passholderId: string,
  postPassholdersPassholderIdCheckinBody: PostPassholdersPassholderIdCheckinBody,
  options?: AxiosRequestConfig
...
export const getPostPassholdersPassholderIdCheckinMutationOptions = <
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PostPassholdersPassholderIdCheckinMutationResult = NonNullable<
  Awaited<ReturnType<typeof postPassholdersPassholderIdCheckin>>
>;
export type PostPassholdersPassholderIdCheckinMutationBody =
  PostPassholdersPassholderIdCheckinBody;
export type PostPassholdersPassholderIdCheckinMutationError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse
>;
 ...
 * @summary Check-in passholder using a check-in code
 */
export const usePostPassholdersPassholderIdCheckin = <
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  const mutationOptions =
    getPostPassholdersPassholderIdCheckinMutationOptions(options);
...
export const getGetPassholdersPassholderIdTransactionsQueryKey = (
  passholderId: string,
  params?: GetPassholdersPassholderIdTransactionsParams
) => {
  return [
...
export const getGetPassholdersPassholderIdTransactionsQueryOptions = <
  TData = Awaited<ReturnType<typeof getPassholdersPassholderIdTransactions>>,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
>(
  passholderId: string,
  params?: GetPassholdersPassholderIdTransactionsParams,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetPassholdersPassholderIdTransactionsQueryKey(passholderId, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPassholdersPassholderIdTransactions>>
  > = ({ signal }) =>
    getPassholdersPassholderIdTransactions(passholderId, params, {
      signal,
      ...axiosOptions,
    });
...
export type GetPassholdersPassholderIdTransactionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPassholdersPassholderIdTransactions>>
>;
export type GetPassholdersPassholderIdTransactionsQueryError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse
>;
 ...
 * @summary Retrieve transaction history of a passholder
 */
export const useGetPassholdersPassholderIdTransactions = <
  TData = Awaited<ReturnType<typeof getPassholdersPassholderIdTransactions>>,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
>(
  passholderId: string,
  ...
  const queryOptions = getGetPassholdersPassholderIdTransactionsQueryOptions(
    passholderId,
    params,
    options
  );
...
export const getPassesUitpasNumber = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/passes/${uitpasNumber}`, options);
};
...
>(
  ...
  const queryOptions = getGetPassesUitpasNumberQueryOptions(
    uitpasNumber,
    options
  );
...
export const getInszNumbersInszNumber = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/insz-numbers/${inszNumber}`, options);
};
...
>(
  ...
  const queryOptions = getGetInszNumbersInszNumberQueryOptions(
    inszNumber,
    options
  );
...
export const getChipNumbersChipNumber = (
  ...
  return axios.get(`NEXT_PUBLIC_API_PATH/chip-numbers/${chipNumber}`, options);
};
...
export const getGetChipNumbersChipNumberQueryOptions = <
...
>(
  ...
  const queryOptions = getGetChipNumbersChipNumberQueryOptions(
    chipNumber,
    options
  );
...
export const getPassholdersStatusInszNumbersInsznumberQueryKey = (
  inszNumber: string
) => {
  return [
    `NEXT_PUBLIC_API_PATH/passholders/status/insz-numbers/${inszNumber}`,
...
export const getPassholdersStatusInszNumbersInsznumberQueryOptions = <
  TData = Awaited<ReturnType<typeof passholdersStatusInszNumbersInsznumber>>,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse | void>,
>(
  inszNumber: string,
  options?: {
    query?: Partial<
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getPassholdersStatusInszNumbersInsznumberQueryKey(inszNumber);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof passholdersStatusInszNumbersInsznumber>>
  > = ({ signal }) =>
    passholdersStatusInszNumbersInsznumber(inszNumber, {
      signal,
      ...axiosOptions,
    });
...
export type PassholdersStatusInszNumbersInsznumberQueryResult = NonNullable<
  Awaited<ReturnType<typeof passholdersStatusInszNumbersInsznumber>>
>;
export type PassholdersStatusInszNumbersInsznumberQueryError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse | void
>;

/**
 * @summary Retrieve the status of a passholder based on INSZ number
 */
export const usePassholdersStatusInszNumbersInsznumber = <
  TData = Awaited<ReturnType<typeof passholdersStatusInszNumbersInsznumber>>,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse | void>,
>(
  inszNumber: string,
  ...
  const queryOptions = getPassholdersStatusInszNumbersInsznumberQueryOptions(
    inszNumber,
    options
  );
