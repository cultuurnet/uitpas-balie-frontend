...
export const getPassholdersPassholderIdAssociationMemberships = (
    passholderId: string,
    params: GetPassholdersPassholderIdAssociationMembershipsParams, options?: AxiosRequestConfig
...
export const getGetPassholdersPassholderIdAssociationMembershipsQueryKey = (passholderId: string,
    ...
    return [`NEXT_PUBLIC_API_PATH/passholders/${passholderId}/association-memberships`, ...(params ? [params]: [])] as const;
    }

    
export const getGetPassholdersPassholderIdAssociationMembershipsQueryOptions = <TData = Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(passholderId: string,
    params: GetPassholdersPassholderIdAssociationMembershipsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPassholdersPassholderIdAssociationMembershipsQueryKey(passholderId,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>> = ({ signal }) => getPassholdersPassholderIdAssociationMemberships(passholderId,params, { signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(passholderId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>, TError, TData> & { queryKey: QueryKey }
}
...
export type GetPassholdersPassholderIdAssociationMembershipsQueryError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>

/**
 * @summary Get association memberships of passholder
 */
export const useGetPassholdersPassholderIdAssociationMemberships = <TData = Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 passholderId: string,
    params: GetPassholdersPassholderIdAssociationMembershipsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getPassholdersPassholderIdAssociationMemberships>>, TError, TData>>, axios?: AxiosRequestConfig}
