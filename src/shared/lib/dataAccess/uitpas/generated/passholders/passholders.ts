...
export const getGetPassholdersUrl = (params?: GetPassholdersParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/app/api/proxy/uitpas/passholders?${stringifiedParams}` : `/app/api/proxy/uitpas/passholders`
}
...
export const getGetPassholdersQueryKey = (params?: GetPassholdersParams,) => {
    return [
    `/app/api/proxy/uitpas/passholders`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getPostPassholdersUrl = () => {
  ...
  return `/app/api/proxy/uitpas/passholders`
}
...
export const getDeletePassholdersPassholderIdUrl = (passholderId: string,) => {
  ...
  return `/app/api/proxy/uitpas/passholders/${passholderId}`
}
...
export const getGetPassholdersPassholderIdPictureUrl = (passholderId: string,) => {
  ...
  return `/app/api/proxy/uitpas/passholders/${passholderId}/picture`
}
...
export const getGetPassholdersPassholderIdPictureQueryKey = (passholderId: string,) => {
    return [
    `/app/api/proxy/uitpas/passholders/${passholderId}/picture`
    ] as const;
    }
...
export const getGetPassholdersPassholderIdAssociationMembershipsUrl = (passholderId: string,
  ...
  return stringifiedParams.length > 0 ? `/app/api/proxy/uitpas/passholders/${passholderId}/association-memberships?${stringifiedParams}` : `/app/api/proxy/uitpas/passholders/${passholderId}/association-memberships`
}
...
export const getGetPassholdersPassholderIdAssociationMembershipsQueryKey = (passholderId: string,
    params?: GetPassholdersPassholderIdAssociationMembershipsParams,) => {
    return [
    `/app/api/proxy/uitpas/passholders/${passholderId}/association-memberships`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetPassholdersMembershipPricesCardSystemIdUrl = (cardSystemId: number,
  ...
  return stringifiedParams.length > 0 ? `/app/api/proxy/uitpas/passholders/membership-prices/${cardSystemId}?${stringifiedParams}` : `/app/api/proxy/uitpas/passholders/membership-prices/${cardSystemId}`
}
...
export const getGetPassholdersMembershipPricesCardSystemIdQueryKey = (cardSystemId: number,
    params?: GetPassholdersMembershipPricesCardSystemIdParams,) => {
    return [
    `/app/api/proxy/uitpas/passholders/membership-prices/${cardSystemId}`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetPassholdersPassholderIdMembershipPricesCardSystemIdUrl = (passholderId: string,
  ...
  return stringifiedParams.length > 0 ? `/app/api/proxy/uitpas/passholders/${passholderId}/membership-prices/${cardSystemId}?${stringifiedParams}` : `/app/api/proxy/uitpas/passholders/${passholderId}/membership-prices/${cardSystemId}`
}
...
export const getGetPassholdersPassholderIdMembershipPricesCardSystemIdQueryKey = (passholderId: string,
    ...
    params?: GetPassholdersPassholderIdMembershipPricesCardSystemIdParams,) => {
    return [
    `/app/api/proxy/uitpas/passholders/${passholderId}/membership-prices/${cardSystemId}`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getPostPassholdersPassholderIdCheckinUrl = (passholderId: string,) => {
  ...
  return `/app/api/proxy/uitpas/passholders/${passholderId}/checkins`
}
...
export const getGetPassholdersPassholderIdTransactionsUrl = (passholderId: string,
  ...
  return stringifiedParams.length > 0 ? `/app/api/proxy/uitpas/passholders/${passholderId}/transactions?${stringifiedParams}` : `/app/api/proxy/uitpas/passholders/${passholderId}/transactions`
}
...
export const getGetPassholdersPassholderIdTransactionsQueryKey = (passholderId: string,
    params?: GetPassholdersPassholderIdTransactionsParams,) => {
    return [
    `/app/api/proxy/uitpas/passholders/${passholderId}/transactions`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetPassesUitpasNumberUrl = (uitpasNumber: string,) => {
  ...
  return `/app/api/proxy/uitpas/passes/${uitpasNumber}`
}
...
export const getGetPassesUitpasNumberQueryKey = (uitpasNumber: string,) => {
    return [
    `/app/api/proxy/uitpas/passes/${uitpasNumber}`
    ] as const;
    }
...
export const getGetInszNumbersInszNumberUrl = (inszNumber: string,) => {
  ...
  return `/app/api/proxy/uitpas/insz-numbers/${inszNumber}`
}
...
export const getGetInszNumbersInszNumberQueryKey = (inszNumber: string,) => {
    return [
    `/app/api/proxy/uitpas/insz-numbers/${inszNumber}`
    ] as const;
    }
...
export const getGetChipNumbersChipNumberUrl = (chipNumber: string,) => {
  ...
  return `/app/api/proxy/uitpas/chip-numbers/${chipNumber}`
}
...
export const getGetChipNumbersChipNumberQueryKey = (chipNumber: string,) => {
    return [
    `/app/api/proxy/uitpas/chip-numbers/${chipNumber}`
    ] as const;
    }
...
export const getPassholdersStatusInszNumbersInsznumberUrl = (inszNumber: string,) => {
  ...
  return `/app/api/proxy/uitpas/passholders/status/insz-numbers/${inszNumber}`
}
...
export const getPassholdersStatusInszNumbersInsznumberQueryKey = (inszNumber: string,) => {
    return [
    `/app/api/proxy/uitpas/passholders/status/insz-numbers/${inszNumber}`
    ] as const;
    }
