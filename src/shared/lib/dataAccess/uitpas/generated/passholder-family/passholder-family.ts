...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPassholdersPassholderIdFamilyMembersQueryKey(passholderId);
   ...
   return  { queryKey, queryFn, enabled: !!(passholderId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPassholdersPassholderIdFamilyMembers>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPassholdersPassholderIdFamiliesQueryKey(passholderId);
   ...
   return  { queryKey, queryFn, enabled: !!(passholderId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPassholdersPassholderIdFamilies>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
