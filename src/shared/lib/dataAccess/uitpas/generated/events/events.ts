...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEventsCardSystemsQueryKey(eventId);
   ...
   return  { queryKey, queryFn, enabled: !!(eventId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEventsCardSystems>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEventsSettingsQueryKey(eventId);
   ...
   return  { queryKey, queryFn, enabled: !!(eventId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEventsSettings>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEventsQrCheckincodesDownloadlinkQueryKey(eventId,params);
   ...
   return  { queryKey, queryFn, enabled: !!(eventId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEventsQrCheckincodesDownloadlink>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
