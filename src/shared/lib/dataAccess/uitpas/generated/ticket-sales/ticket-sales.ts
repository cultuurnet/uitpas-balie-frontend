...
export const useGetTariffs = <TData = Awaited<ReturnType<typeof getTariffs>>, TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>>(
 params: GetTariffsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTariffs>>, TError, TData>>, axios?: AxiosRequestConfig}
...
export const useGetTariffsStatic = <TData = Awaited<ReturnType<typeof getTariffsStatic>>, TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>>(
 params: GetTariffsStaticParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTariffsStatic>>, TError, TData>>, axios?: AxiosRequestConfig}
...
export const getGetTicketSalesQueryOptions = <TData = Awaited<ReturnType<typeof getTicketSales>>, TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>>(params: GetTicketSalesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTicketSales>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
export type GetTicketSalesQueryError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>

/**
 * @summary Retrieve existing ticket sales
 */
export const useGetTicketSales = <TData = Awaited<ReturnType<typeof getTicketSales>>, TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>>(
 params: GetTicketSalesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTicketSales>>, TError, TData>>, axios?: AxiosRequestConfig}
