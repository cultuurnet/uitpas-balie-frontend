...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTariffsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTariffs>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTariffsStaticQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTariffsStatic>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTicketSalesQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTicketSales>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
