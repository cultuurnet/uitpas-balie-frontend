...
export const getGetUitidPassholderRegistrationTokenUrl = () => {
  ...
  return `/app/api/proxy/uitpas/passholders/me/uitid/registration-token`
}
...
export const getGetUitidPassholderRegistrationTokenQueryKey = () => {
    return [
    `/app/api/proxy/uitpas/passholders/me/uitid/registration-token`
    ] as const;
    }
...
export const getGetUitidPassholderStatusUrl = () => {
  ...
  return `/app/api/proxy/uitpas/passholders/me/uitid/status`
}
...
export const getGetUitidPassholderStatusQueryKey = () => {
    return [
    `/app/api/proxy/uitpas/passholders/me/uitid/status`
    ] as const;
    }
...
export const getRegisterUitidPassholderUrl = () => {
  ...
  return `/app/api/proxy/uitpas/passholders/me/uitid`
}
...
export const getGetPassholdersMeUrl = () => {
  ...
  return `/app/api/proxy/uitpas/passholders/me`
}
...
export const getGetPassholdersMeQueryKey = () => {
    return [
    `/app/api/proxy/uitpas/passholders/me`
    ] as const;
    }
