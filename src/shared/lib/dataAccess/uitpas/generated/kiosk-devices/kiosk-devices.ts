...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetKiosksQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getKiosks>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetKiosksEventQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getKiosksEvent>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetKiosksCheckinsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getKiosksCheckins>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetKiosksChipNumbersChipNumberQueryKey(chipNumber);
   ...
   return  { queryKey, queryFn, enabled: !!(chipNumber), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getKiosksChipNumbersChipNumber>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
