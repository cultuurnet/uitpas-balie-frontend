...
export const getGetOrganizersFinancialReportsPeriodsInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsPeriods>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(organizerId: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsPeriods>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Get suggested financial report periods
 */
export const useGetOrganizersFinancialReportsPeriodsInfinite = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsPeriods>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 organizerId: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsPeriods>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getGetOrganizersFinancialReportsInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReports>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(organizerId: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReports>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Get financial report exports
 */
export const useGetOrganizersFinancialReportsInfinite = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReports>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 organizerId: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReports>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getGetOrganizersFinancialReportsReportIdInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportId>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportId>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Get financial report status
 */
export const useGetOrganizersFinancialReportsReportIdInfinite = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportId>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportId>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getGetOrganizersFinancialReportsReportIdDownloadLinkInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdDownloadLink>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdDownloadLink>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Get financial report temporary download link
 */
export const useGetOrganizersFinancialReportsReportIdDownloadLinkInfinite = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdDownloadLink>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdDownloadLink>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getGetOrganizersFinancialReportsReportIdZipInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdZip>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdZip>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
 ...
 * @summary Download financial report
 */
export const useGetOrganizersFinancialReportsReportIdZipInfinite = <TData = Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdZip>>, TError = AxiosError<UnauthorizedResponse | ForbiddenResponse | Error>>(
 organizerId: string,
    reportId: number, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getOrganizersFinancialReportsReportIdZip>>, TError, TData>, axios?: AxiosRequestConfig}
