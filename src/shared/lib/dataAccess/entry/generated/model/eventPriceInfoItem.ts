...
import type { EventPriceInfoItemCategory } from './eventPriceInfoItemCategory';
import type { EventPriceInfoItemPriceCurrency } from './eventPriceInfoItemPriceCurrency';

export type EventPriceInfoItem = unknown & {
...
`base` for the base price, and `tariff` for custom/extra tariffs.  Tariffs with category `uitpas` are automatically added by UiTdatabank and read-only. They will be updated whenever other tariffs change. */
  category: EventPriceInfoItemCategory;
  /**
  ...
  priceCurrency?: EventPriceInfoItemPriceCurrency;
