 ...
 */
import type { EventVideosPatchItem } from './eventVideosPatchItem';

/**
 * Describes the request body to update one or more videos on an event.
 */
export type EventVideosPatch = EventVideosPatchItem[];
