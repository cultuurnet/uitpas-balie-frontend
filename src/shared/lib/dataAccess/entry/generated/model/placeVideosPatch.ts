 ...
 */
import type { PlaceVideosPatchItem } from './placeVideosPatchItem';

/**
 * Describes the request body to update one or more videos on a place.
 */
export type PlaceVideosPatch = PlaceVideosPatchItem[];
