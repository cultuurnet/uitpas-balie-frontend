...
Base components live in `src/ui/shadcn/` and are generated by the shadcn CLI. **Never edit these files directly** — they get overwritten when updated via `npx shadcn add <component>`.
